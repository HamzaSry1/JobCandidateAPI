namespace JobCandidateAPI.Contracts.Const
{
    public static class Messages
    {
        ...
        public const string CandidateFound = "Candidate found.";
        public const string CandidateDeletedSuccessfully = "Candidate information has been deleted successfully.";
